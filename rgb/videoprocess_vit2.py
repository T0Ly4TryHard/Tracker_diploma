...
import cv2
from VIT2.tracker import Tracker
from VIT2.wrapper import TrackerWrapper
import numpy as np
import json
import sys
import time
...
class VideoProcessor:
    def __init__(self, video_path, roi):
        ...
        self.roi = roi
        self.treacker = Tracker(model_path="./VIT2/MobileViTv2_Track_ep0300.onnx")
