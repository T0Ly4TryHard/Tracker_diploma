...
import cv2
from VIT.tracker import Tracker
from VIT.wrapper import TrackerWrapper
import numpy as np
import json
import sys
import time
...
class VideoProcessor:
    def __init__(self, video_path, roi):
        ...
        self.roi = roi
        self.treacker = Tracker(model_path="./VIT/MobileViT_Track_ep0300.onnx")
